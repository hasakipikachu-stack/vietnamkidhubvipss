...
-- ĐÃ TÍCH HỢP LINK KIẾM TIỀN CHÍNH CHỦ CỦA BẠN
local KeySystemURL = "https://direct-link.net/9282255/668THuz6EvL7" 
-- Link chứa danh sách các Key chuẩn của bạn (Ví dụ file Rentry raw)
local KeyListURL = "https://rentry.co/bswgrmu3/raw"
...
local function CheckOnlineKey(inputKey)
    ...
    if success and response then
        for keyInList in response:gmatch("[^\r\n]+") do
            keyInList = keyInList:gsub("%s+", "")
            if inputKey == keyInList or keyInList:find(inputKey) then
                return true
            end
        end
    end
...
-- GIAO DIỆN KEY SYSTEM CHUYÊN NGHIỆP
local KeyUI = Instance.new("ScreenGui")
KeyUI.Name = "VietNamKidKeySystem"
KeyUI.Parent = game:GetService("CoreGui") or game.Players.LocalPlayer:WaitForChild("PlayerGui")
...
Title.Text = "🛡️ VIETNAM KID HUB | PREMIUM KEY"
...
TextBox.PlaceholderText = "Dán Key bản quyền vào đây..."
TextBox.Text = ""
TextBox.TextColor3 = Color3.fromRGB(255, 255, 255)
TextBox.BackgroundColor3 = Color3.fromRGB(25, 30, 42)
TextBox.TextSize = 13
...
BtnCheck.Position = UDim2.new(0.075, 0, 0.58, 0)
BtnCheck.Text = "Xác Thực Key"
BtnCheck.BackgroundColor3 = Color3.fromRGB(0, 122, 255)
...
BtnGet.Position = UDim2.new(0.525, 0, 0.58, 0)
BtnGet.Text = "Lấy Key Kiếm Tiền"
BtnGet.BackgroundColor3 = Color3.fromRGB(40, 167, 69)
BtnGet.TextColor3 = Color3.fromRGB(255, 255, 255)
BtnGet.TextSize = 13
BtnGet.Font = Enum.Font.GothamBold

local BtnGetCorner = Instance.new("UICorner")
BtnGetCorner.CornerRadius = UDim.new(0, 8)
...
-- Nút lấy key tự động copy link kiếm tiền và hiển thị popup hướng dẫn
BtnGet.MouseButton1Click:Connect(function()
    ...
    NotifGui.Name = "VietNamKidNotif"
    NotifGui.Parent = game:GetService("CoreGui") or game.Players.LocalPlayer:WaitForChild("PlayerGui")

    local NotifBox = Instance.new("Frame")
    NotifBox.Parent = NotifGui
    NotifBox.Size = UDim2.new(0, 320, 0, 140)
    NotifBox.Position = UDim2.new(0.5, -160, 0.3, 0)
    NotifBox.BackgroundColor3 = Color3.fromRGB(20, 25, 35)
    ...
    NotifTitle.Text = "🔗 ĐÃ COPY LINK LẤY KEY!"
    ...
    NotifDesc.Parent = NotifBox
    NotifDesc.Size = UDim2.new(0.9, 0, 0, 50)
    NotifDesc.Position = UDim2.new(0.05, 0, 0.3, 0)
    NotifDesc.Text = "Link vượt quảng cáo đã lưu vào Clipboard.\n1. Dán vào trình duyệt để hoàn thành vượt link.\n2. Nhận key và dán vào ô xác thực nhé!"
    NotifDesc.TextColor3 = Color3.fromRGB(200, 200, 200)
    NotifDesc.TextSize = 12
    NotifDesc.Font = Enum.Font.Gotham
    NotifDesc.BackgroundTransparency = 0.3
    NotifDesc.BackgroundColor3 = Color3.fromRGB(15, 20, 28)
    NotifDesc.TextWrapped = true

    local DescCorner = Instance.new("UICorner")
    DescCorner.CornerRadius = UDim.new(0, 6)
    DescCorner.Parent = NotifDesc

    local CloseBtn = Instance.new("TextButton")
    CloseBtn.Parent = NotifBox
    CloseBtn.Size = UDim2.new(0.5, 0, 0, 30)
    CloseBtn.Position = UDim2.new(0.25, 0, 0.75, 0)
    CloseBtn.Text = "ĐÃ HIỂU / ĐÓNG"
    CloseBtn.BackgroundColor3 = Color3.fromRGB(0, 122, 255)
    ...
    Status.Text = "Đã copy link và hiện bảng hướng dẫn!"
end)
...
local function LoadMainHub()
    ...
    local Window = Fluent:CreateWindow({
        ...
        SubTitle = "Update 30 Monetized Edition",
        TabWidth = 160,
...
BtnCheck.MouseButton1Click:Connect(function()
    ...
    if CheckOnlineKey(userKey) then
        Status.TextColor3 = Color3.fromRGB(100, 255, 100)
